                  ...
                  <div className="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                    ...
                    <ul className="list-inline d-flex mb-0">
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={amazonpay} alt="Click Mart Payment Partner" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={american} alt="Click Mart Payment Partner" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={mastercard} alt="Click Mart Payment Partner" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={paypal} alt="Click Mart Payment Partner" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={visa} alt="Click Mart Payment Partner" />
                        </Link>
                      </li>
                    </ul>
                  </div>
